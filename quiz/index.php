...
<html lang="en" dir="ltr">
  ...
  <body onload="getQ()">
    ...
    <div class='container text-center'>
        <kbd><?= $user_name ?> : <?= $rank ?></kbd>
       
    </div>
    <div class="container mt-3 border" id='main'>
        <div class="row">
            <div class="col-sm p-3 " id='i'>
                    ...
                    <form id='submitF'>
                        <div class='form-group'>
                            ...
                            <div class="container" id='stuff'>
                                      <input type='submit' id='sub' class='btn btn-primary mt-3'>
      ...
      <div class="container-fluid text-center mt-3 bg-dark fixed-bottom">
        <kbd>TEAM 12</kbd>
      </div>
<script>
    var num;
  ...
  do {
    ...
    function getQ()
    {
        $.ajax({
            ...
            success:function(res)
            {
                ...
                num=res['n'];
                if(res['f']!="")
                    $("#i").html("<img class='img-fluid float-right' src="+res['f']+">")
    ...
    $("#submitF").submit(function(e)
    {
        ...
        $.ajax({
            ...
            method:"POST",
            data:{num:num,answer:$("#answer").val()},
            success:function(res)
            {
